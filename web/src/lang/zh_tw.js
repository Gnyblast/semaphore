export default {
  ...
  orCreateNewAdminUser: '或創建新管理員使用者：',
  close2: '關閉',
  semaphore: '信號燈',
  ...
  branch: '分支',
  accessKey: '訪問金鑰',
  credentialsToAccessToTheGitRepositoryItShouldBe: '訪問 Git 儲存庫的憑證。應為：',
  ...
  playbook_filename_required: 'Playbook 檔名為必填',
